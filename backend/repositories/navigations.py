...
from schemas.navigations import NavigationSchema, NavigationInSchema, NavigationOutSchema
...
def update_item(db: Session, id: UUID, item: NavigationInSchema) -> NavigationOutSchema:
